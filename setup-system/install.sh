...
# enable services
systemctl enable dhcpcd.service slim.service
...
# create user
useradd -m -G disk,wheel,uucp,games,lock,kvm,video -s /usr/bin/zsh itachi
echo 'get PASSWORD itachi'
passwd itachi
...
git config --global core.excludefile "/home/itachi/.gitignore"
